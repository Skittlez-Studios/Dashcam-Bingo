...
`;class Oe extends f{static styles=[Ue,x];static properties={pressing:{type:Boolean,state:!0}};constructor(){super(),this.pressing=!1}handleClick(){p.play("click"),this.dispatchEvent(new CustomEvent("reset-requested",{bubbles:!0,composed:!0}))}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
        ...
        `}}customElements.define("reset-button",Oe);const Ne=b`
    :host {
        --card: #1e293b;
        --foreground: #f1f5f9;
        --muted-foreground: #94a3b8;
...
`;class Ie extends f{static styles=[Ne,x];static properties={open:{type:Boolean},pressingButton:{type:String,state:!0}};constructor(){super(),this.open=!1,this.pressingButton=null}handleConfirm(){p.play("click"),this.dispatchEvent(new CustomEvent("confirm",{detail:{confirmed:!0},bubbles:!0,composed:!0}))}handleCancel(){p.play("click"),this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}handleBackdropClick(e){e.target===e.currentTarget&&this.handleCancel()}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return this.open?l`
    ...
    `:l``}}customElements.define("confirmation-modal",Ie);const We=b`
    :host {
        --card: #1e293b;
        --foreground: #f1f5f9;
        --muted-foreground: #94a3b8;
...
`;class Ye extends f{static styles=[qe,x];static properties={enabled:{type:Boolean,state:!0},pressing:{type:Boolean,state:!0}};constructor(){super(),this.enabled=p.isEnabled(),this.pressing=!1,this.handleSoundToggle=this.handleSoundToggle.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("sound-toggled",this.handleSoundToggle)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sound-toggled",this.handleSoundToggle)}handleSoundToggle(e){this.enabled=e.detail.enabled}toggle(){this.enabled=p.toggle(),this.enabled&&p.play("click")}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
        ...
        `}}customElements.define("sound-toggle",Ye);const Ve=b`
    :host {
        display: block;
    }
...
`;class Ge extends f{static styles=[Ve,x];static properties={pressing:{type:Boolean,state:!0}};constructor(){super(),this.pressing=!1}handleClick(){p.play("click"),this.dispatchEvent(new CustomEvent("help-requested",{bubbles:!0,composed:!0}))}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
            <button 
                @click=${this.handleClick}
                @touchstart=${this.handleTouchStart}
                @touchend=${this.handleTouchEnd}
