...
`;class Ke extends f{static styles=[We,x];static properties={open:{type:Boolean},pressingButton:{type:String,state:!0}};constructor(){super(),this.open=!1,this.pressingButton=null}handleClose(){p.play("click"),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}handlePlayAgain(){p.play("click"),this.dispatchEvent(new CustomEvent("play-again",{bubbles:!0,composed:!0}))}handleBackdropClick(e){e.target===e.currentTarget&&this.handleClose()}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return this.open?l`
        ...
        `:l``}}customElements.define("winner-modal",Ke);const Ve=b`
    :host {
...
`;class qe extends f{static styles=[Ve,x];static properties={enabled:{type:Boolean,state:!0},pressing:{type:Boolean,state:!0}};constructor(){super(),this.enabled=p.isEnabled(),this.pressing=!1,this.handleSoundToggle=this.handleSoundToggle.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("sound-toggled",this.handleSoundToggle)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sound-toggled",this.handleSoundToggle)}handleSoundToggle(e){this.enabled=e.detail.enabled}toggle(){this.enabled=p.toggle(),this.enabled&&p.play("click")}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
        ...
        `}}customElements.define("sound-toggle",qe);const Ye=b`
    :host {
        display: block;
    }
