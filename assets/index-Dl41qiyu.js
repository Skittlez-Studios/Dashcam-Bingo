...
`;class Oe extends b{static styles=[Ue,w];static properties={pressingButton:{type:String,state:!0},customCard:{type:Object}};constructor(){super(),this.pressingButton=null,this.customCard=null}selectDifficulty(e){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("difficulty-selected",{detail:{difficulty:e},bubbles:!0,composed:!0}))}handleRemoveCard(e){e.stopPropagation(),p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("remove-custom-card",{bubbles:!0,composed:!0}))}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return l`
            <div class="backdrop">
...
`;class Ie extends b{static styles=[Ne,w];static properties={pressing:{type:Boolean,state:!0}};constructor(){super(),this.pressing=!1}handleClick(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("reset-requested",{bubbles:!0,composed:!0}))}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
            <button 
...
`;class Ke extends b{static styles=[We,w];static properties={open:{type:Boolean},pressingButton:{type:String,state:!0}};constructor(){super(),this.open=!1,this.pressingButton=null}handleConfirm(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("confirm",{detail:{confirmed:!0},bubbles:!0,composed:!0}))}handleCancel(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}handleBackdropClick(e){e.target===e.currentTarget&&this.handleCancel()}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return this.open?l`
...
`;class qe extends b{static styles=[Ve,w];static properties={open:{type:Boolean},pressingButton:{type:String,state:!0}};constructor(){super(),this.open=!1,this.pressingButton=null}handleClose(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}handlePlayAgain(){p.play("click"),this.dispatchEvent(new CustomEvent("play-again",{bubbles:!0,composed:!0}))}handleBackdropClick(e){e.target===e.currentTarget&&this.handleClose()}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return this.open?l`
            <div class="backdrop" @click=${this.handleBackdropClick}>
                <div class="modal">
...
`;class Xe extends b{static styles=[Fe,w];static properties={pressing:{type:Boolean,state:!0}};constructor(){super(),this.pressing=!1}handleClick(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("help-requested",{bubbles:!0,composed:!0}))}handleTouchStart(){this.pressing=!0}handleTouchEnd(){this.pressing=!1}render(){return l`
            <button 
                @click=${this.handleClick}
                @touchstart=${this.handleTouchStart}
                @touchend=${this.handleTouchEnd}
...
`;class Ze extends b{static styles=Je;static properties={open:{type:Boolean},currentPage:{type:Number,state:!0},touchStartX:{type:Number,state:!0},touchEndX:{type:Number,state:!0}};constructor(){super(),this.open=!1,this.currentPage=0,this.pages=["intro","what-are-dashcams","rules","where-to-find"],this.touchStartX=0,this.touchEndX=0}updated(e){e.has("open")&&this.open&&(this.currentPage=0)}handleClose(){p.play("click"),m.vibrate(2),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}handleBackdropClick(e){e.target===e.currentTarget&&this.handleClose()}nextPage(){p.play("click"),m.vibrate(2),this.currentPage<this.pages.length-1&&this.currentPage++}prevPage(){p.play("click"),m.vibrate(2),this.currentPage>0&&this.currentPage--}handleTouchStart(e){this.touchStartX=e.changedTouches[0].screenX}handleTouchEnd(e){this.touchEndX=e.changedTouches[0].screenX,this.handleSwipe()}handleSwipe(){const t=this.touchStartX-this.touchEndX;Math.abs(t)>75&&(t>0?this.nextPage():this.prevPage())}renderPage(){switch(this.pages[this.currentPage]){case"intro":return l`
                    <section>
...
`;class st extends b{static styles=[nt,w];static properties={open:{type:Boolean,reflect:!0},code:{type:String},pressingButton:{type:String,state:!0},copied:{type:Boolean,state:!0},showWarning:{type:Boolean,state:!0}};constructor(){super(),this.open=!1,this.code="",this.pressingButton=null,this.copied=!1,this.showWarning=!1}async handleCopyCode(){p.play("click"),m.vibrate(2);try{navigator.clipboard&&navigator.clipboard.writeText?(await navigator.clipboard.writeText(this.code),this.copied=!0):this.fallbackCopyToClipboard(this.code),setTimeout(()=>{this.copied=!1},2e3)}catch(e){console.error("Copy failed, trying fallback:",e),this.fallbackCopyToClipboard(this.code)}}fallbackCopyToClipboard(e){const t=document.createElement("textarea");if(t.value=e,t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.width="2em",t.style.height="2em",t.style.padding="0",t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.style.background="transparent",t.setAttribute("readonly",""),t.style.opacity="0",document.body.appendChild(t),t.focus(),t.select(),navigator.userAgent.match(/ipad|iphone/i)){const r=document.createRange();r.selectNodeContents(t);const i=window.getSelection();i.removeAllRanges(),i.addRange(r),t.setSelectionRange(0,999999)}try{document.execCommand("copy")&&(this.copied=!0,setTimeout(()=>{this.copied=!1},2e3))}catch(r){console.error("Fallback copy failed:",r),alert(`Kon niet automatisch kopiëren. Code: ${e}`)}document.body.removeChild(t)}handleCloseAttempt(){p.play("click"),m.vibrate(2),this.showWarning=!0}handleConfirmClose(){p.play("click"),m.vibrate(2),this.open=!1,this.showWarning=!1,this.copied=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}handleCancelClose(){p.play("click"),m.vibrate(2),this.showWarning=!1}handleTouchStart(e){this.pressingButton=e}handleTouchEnd(){this.pressingButton=null}render(){return this.open?l`
